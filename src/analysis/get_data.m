function [pos_record, wrench_record] = get_data(filename, shape_id, do_plot)
% Input: 
% 1. File path 
...
% 'hex', 1);
%
jsonlab_path = '/Users/madaolin/Dropbox (MIT)/Daolin Lab Repo/Projects/2017 Analysis of Planar Pushing Data/matlab'
addpath(strcat(jsonlab_path,'/Json/fsroot/jsonlab'));

data = loadjson(filename);
pos_record = data.pos_record; 
wrench_record = data.wrench_record;
